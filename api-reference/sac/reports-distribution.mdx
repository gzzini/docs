...
api: "GET https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/distribuicao"
...
```bash Com Período
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/distribuicao?data_inicio=2024-01-01&data_fim=2024-01-31" \
  -H "Authorization: Bearer seu_token_jwt"
```
