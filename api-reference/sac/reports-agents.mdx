...
api: "GET https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/agentes"
...
```bash Básico
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/agentes" \
