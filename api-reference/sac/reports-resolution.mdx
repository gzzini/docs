...
api: "GET https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/resolucao"
...
```bash Básico
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/resolucao" \
  -H "Authorization: Bearer seu_token_jwt"
```

```bash Com Período
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/resolucao?data_inicio=2024-01-01&data_fim=2024-01-31" \
  -H "Authorization: Bearer seu_token_jwt"
```
