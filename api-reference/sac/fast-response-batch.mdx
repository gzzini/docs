...
api: "POST https://worker.thenewscc.com/support/fast-response/lote"
    ...
    <ResponseField name="respostas" type="array">
      ...
      <Expandable title="Estrutura da resposta">
        ...
        <ResponseField name="resposta" type="string">
          Resposta gerada em formato HTML
        </ResponseField>
...
curl -X POST https://worker.thenewscc.com/support/fast-response/lote \
