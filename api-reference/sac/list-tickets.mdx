...
<ParamField query="email" type="string">
  Filtrar por email do solicitante
</ParamField>
...
```bash Filtrar por Email
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support?email=usuario@exemplo.com&sortField=email&sort=asc" \
  -H "Authorization: Bearer seu_token_jwt"
```
