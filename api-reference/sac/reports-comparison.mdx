...
api: "GET https://worker.thenewscc.com/support/relatorios/comparativo"
...
curl -X GET "https://worker.thenewscc.com/support/relatorios/comparativo?data_inicio=2024-01-01&data_fim=2024-01-31&comparar_com=periodo_anterior" \
  -H "Authorization: Bearer seu_token_jwt"
```

```bash Mesmo Período Ano Anterior
curl -X GET "https://worker.thenewscc.com/support/relatorios/comparativo?data_inicio=2024-01-01&data_fim=2024-01-31&comparar_com=mesmo_periodo_ano_anterior" \
  -H "Authorization: Bearer seu_token_jwt"
```
