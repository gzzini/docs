...
api: "GET https://worker.thenewscc.com/support/relatorios/issues"
...
```bash Básico
curl -X GET "https://worker.thenewscc.com/support/relatorios/issues" \
  -H "Authorization: Bearer seu_token_jwt"
```

```bash Por Semana
curl -X GET "https://worker.thenewscc.com/support/relatorios/issues?data_inicio=2024-01-01&data_fim=2024-01-31&agrupar_por=semana" \
  -H "Authorization: Bearer seu_token_jwt"
```
