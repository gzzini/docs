...
api: "GET https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/serie-temporal"
...
```bash Por Dia
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/serie-temporal?data_inicio=2024-01-01&data_fim=2024-01-31&agrupar_por=dia" \
  -H "Authorization: Bearer seu_token_jwt"
```

```bash Por Hora
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support/relatorios/serie-temporal?data_inicio=2024-01-15&data_fim=2024-01-15&agrupar_por=hora" \
  -H "Authorization: Bearer seu_token_jwt"
```
