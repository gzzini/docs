---
title: "Anexos"
api: "POST https://sac-waffle-v2.theo-110.workers.dev/support/{id}/anexos"
...
```bash Listar
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support/12345/anexos" \
  -H "Authorization: Bearer seu_token_jwt"
```

```bash Download
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/support/anexos/789/download" \
  -H "Authorization: Bearer seu_token_jwt" \
  -o arquivo_baixado.pdf
```

```bash Excluir
curl -X DELETE "https://sac-waffle-v2.theo-110.workers.dev/support/anexos/789" \
  -H "Authorization: Bearer seu_token_jwt"
```
  ...
  "data": [
    {
      ...
      "tamanhoArquivo": 245760,
      "createdAt": "2024-01-14T15:30:00Z",
      "downloadUrl": "https://sac-waffle-v2.theo-110.workers.dev/support/anexos/789/download"
    },
    {
      "id": 790,
      "supportId": 12345,
      ...
      "downloadUrl": "https://sac-waffle-v2.theo-110.workers.dev/support/anexos/790/download"
    }
  ]
}
```
