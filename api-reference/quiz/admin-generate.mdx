...
api: "POST https://sac-waffle-v2.theo-110.workers.dev/quiz/admin/generate"
...
const response = await fetch('https://sac-waffle-v2.theo-110.workers.dev/quiz/admin/generate', {
  method: 'POST',
  headers: {
