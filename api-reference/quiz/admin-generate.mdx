...
api: "POST https://worker.thenewscc.com/quiz/admin/generate"
...
```bash cURL
curl -X POST https://worker.thenewscc.com/quiz/admin/generate \
  -H "Content-Type: application/json"
```

```javascript JavaScript
const response = await fetch('https://worker.thenewscc.com/quiz/admin/generate', {
  method: 'POST',
  headers: {
