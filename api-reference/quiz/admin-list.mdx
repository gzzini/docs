...
```bash Com Paginação
curl -X GET "https://sac-waffle-v2.theo-110.workers.dev/quiz/admin/list?page=1&limit=10"
```

```javascript JavaScript
const response = await fetch('https://sac-waffle-v2.theo-110.workers.dev/quiz/admin/list?page=1&limit=20', {
  method: 'GET'
});
